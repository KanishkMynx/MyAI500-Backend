...
//       sample_rate: "8000",
//       model: "nova-2",
//       punctuate: false, // Disable for slightly faster results
//       interim_results: true,
//       endpointing: 100, // Lowered for faster pause detection
//       utterance_end_ms: 500, // Lowered for faster end-of-utterance
//     });
...
//           console.log(`[${new Date().toISOString()}] Deepgram transcript event:`, transcriptionEvent);
...
//               console.log(`[${new Date().toISOString()}] Emitted final transcription: ${this.finalResult.trim()}`);
//               return;
//             } else {
//               console.log(
...
//             console.log(`[${new Date().toISOString()}] Emitted interim utterance: ${text}`);
//           }
//         }
//       );
