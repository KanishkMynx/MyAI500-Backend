...
// class GptService extends EventEmitter {
//   constructor(agentType, callSid) {
//     super();
//     this.openai = new OpenAI();
//     this.agentType = agentType;
//     this.callSid = callSid; // Store callSid from constructor
//     this.partialResponseIndex = 0;
//     this.userContext = [];
//     this.initializeAgentPrompt();
//   }
...
//           // Ensure callSid is included in arguments
//           if (functionName === "transferCall" && this.callSid) {
//             validatedArgs = { ...validatedArgs, callSid: this.callSid };
//           }
...
//           // Update context with function response
//           this.updateUserContext(functionName, "function", functionResponse);
...
//       console.log(`GPT -> user context length: ${this.userContext.length}`.green);
//     } catch (error) {
//       console.error(`Error in completion: ${error.message}`.red);
//       throw error;
//     }
//   }
// }
