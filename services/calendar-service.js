...
const getAvailableTimeSlots = async () => {
  ...
  try {
    ...
    console.log('Current IST time:', now.format('YYYY-MM-DD HH:mm:ss A'), 'Available slots for today:', availableSlots);
...
async function bookTimeSlot(startTS, name, clientEmail) {
  ...
  console.log('Booking appointment - startTS:', startTS, 'Parsed IST:', appointmentStartTime.format('YYYY-MM-DD hh:mm A'));
